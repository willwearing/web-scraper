...
class GoogleScraper:
    ...
    def parse(self, html):
        ...
        # Extract data
        title = [title.text for title in content.findAll('span', {'class': 'LC20lb'})]
        print('title: ', title)
    ...
    def write_csv(self):
        ...
        print('Writing results to CSV file...', self.results)
    ...
    def run(self):
        ...
        for page in range(0, 5):
            # Make HTTP GET request
            response = self.fetch('Vancouver Couriers', page)
